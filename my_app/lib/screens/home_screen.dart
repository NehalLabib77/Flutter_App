/// Home: greeting + Popular and Top Rated course lists.
library;
      ...
      body: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            ...
            _Section(title: 'Popular right now', courses: courses.popular),
            const SizedBox(height: 16),
            _Section(title: 'Top rated', courses: courses.topRated),
...
class _Section extends StatelessWidget {
  const _Section({required this.title, required this.courses});
  final String title;
