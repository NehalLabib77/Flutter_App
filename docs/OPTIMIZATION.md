...
> Scope: `E:\Flutter_app\frontend` (was `my_app/` before the 2026-07-29
> monorepo reorg). The backend (`backend/`), models (`ml/artifacts/models/`),
> and notebooks (`ml/notebooks/`) stay untouched. Behaviour, navigation,
> design, state management, API routes, and database names are preserved.
